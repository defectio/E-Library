 ...
 * 
 * @RequestMapping("/admin") : "/admin"에 대한 요청을 AdminController가 처리한다. 
...
public class AdminHomeController {
	 ...
	 * @RequestMapping(value={"", "/"}) : method default가 RequestMethod.GET
	 * @RequestMapping({"", "/"}) : 인자 1개일 경우, value key 생략 가능
	 * @return
	 */
	@RequestMapping(value={"", "/"}, method=RequestMethod.GET)
	public String home() {
